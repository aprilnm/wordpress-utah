...
(function($) {
	...
	$.fn.jVertTabs = function(attr,options) {
        ...
        return this.each(function() {
			...
			var tabColumn = tabRoot.children("div.bw_tabs-column");
			var tabContentColumn = tabRoot.children("div.bw_tabs-content-column");
			//tabColumnHeight = tabColumn.height();
			
			/* locate all li elements  */
			$(this).find(".bw_tabs-column > ul > li").each(function(i){
			...
			$(this).children(".bw_tabs-content-column > div.bw_tabs-content-panel").each(function(i){
				if(i>0){
					$(this).hide();
				}		
			});
		...
		function handleTabClick(li,liIndex,tabRoot,doSelectedCallBack){
			...
			var tabCol = tabRoot.children("div.bw_tabs-column");
			var tabContentCol = tabRoot.children("div.bw_tabs-content-column");
			...
			tabContentCol.children("div.bw_tabs-content-panel").each(function(i){
				$(this).hide();
				if(i == liIndex){
		...
		function getTotalTabsHeight(tabRoot){
			/* locate all li elements  */
			var height = 0;
			tabRoot.find(".bw_tabs-column > ul > li").each(function(i){
		 ...
		 *
		 * tabContentCol - reference to the #bw_tabs-content-column element
		 */
		...
		function setStyle(tabRoot){
			tabRoot.addClass("bw_tabs");
			tabRoot.children("div").eq(0).addClass("bw_tabs-column");
			tabRoot.children("div").eq(1).addClass("bw_tabs-content-column");
			tabRoot.children("div").eq(1).children("div").addClass("bw_tabs-content-panel");
		};
		...
		function adjustMargin(tabRoot){			
			...
			$(tabRoot).children('div.bw_tabs-content-column').css({"margin-left": tabColWidth-1 + "px"});
